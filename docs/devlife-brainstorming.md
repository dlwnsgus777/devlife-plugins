...
5. **설계 섹션 발표** — Architecture / Domain Model(도메인 로직이 없으면 스킵) / Components / Data Flow / Error Handling / Testing 섹션을 하나씩 발표하고 승인 받음, 복잡도에 따라 깊이 조절. 모든 섹션 확인 후 전체 설계를 요약하고 **"문서를 작성할까요?" 명시적 지시를 요청**
