---
name: branch-review
description: Review the current git branch against main, score code quality, tests, domain logic, and design, then save a timestamped report.
---
...
If the user explicitly asks to use a sub-agent, spawn a single fresh sub-agent with this prompt:

> Read `~/.codex/skills/branch-review/SKILL.md` for evaluation criteria, then execute Step 2 through Step 4.

Otherwise, execute Step 2 through Step 4 locally.
