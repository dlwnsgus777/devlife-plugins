...
|--------|---------|---------------|
| [`devlife-planning`](#devlife-planning) | `1.0.0` | 기획 문서화 — 브레인스토밍부터 Spec, 계획, 이력서 문서까지 |
...
기획·문서화 워크플로우. 아이디어 브레인스토밍부터 기술 명세, 태스크 계획, 이력서용 작업 이력 정리까지 커버합니다.
...
| `project-history` | `1.0.0` | Jira 티켓 + git 브랜치 분석 → 이력서용 기술 문서 생성 (한 줄 요약·업무 bullet·면접 Q&A) |
